...
//
//     final placeAutoCompleteResponseModel = placeAutoCompleteResponseModelFromJson(jsonString);

import 'dart:convert';

PlaceAutoCompleteResponseModel placeAutoCompleteResponseModelFromJson(String str) => PlaceAutoCompleteResponseModel.fromJson(json.decode(str));

String placeAutoCompleteResponseModelToJson(PlaceAutoCompleteResponseModel data) => json.encode(data.toJson());
...
class PlaceAutoCompleteResponseModel {
  ...
  factory PlaceAutoCompleteResponseModel.fromJson(Map<String, dynamic> json) => PlaceAutoCompleteResponseModel(
