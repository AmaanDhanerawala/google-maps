...
//
//     final directionResponseModel = directionResponseModelFromJson(jsonString);

import 'dart:convert';

DirectionResponseModel directionResponseModelFromJson(String str) => DirectionResponseModel.fromJson(json.decode(str));

String directionResponseModelToJson(DirectionResponseModel data) => json.encode(data.toJson());
...
class DirectionResponseModel {
  ...
  factory DirectionResponseModel.fromJson(Map<String, dynamic> json) => DirectionResponseModel(
